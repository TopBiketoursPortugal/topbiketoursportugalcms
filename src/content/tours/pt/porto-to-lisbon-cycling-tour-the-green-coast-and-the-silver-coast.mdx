...
content: >-
  ...
  Este **tour de bicicleta do Porto a Lisboa** é uma das formas mais
  impressionantes de descobrir a **Costa Verde** e a **Costa de Prata** de
  Portugal. Concebido como um percurso fácil a moderado, combina extensas
  **ciclovias costeiras**, **paisagens deslumbrantes** e **experiências
  culturais autênticas**. A aventura começa com um **city tour no Porto**,
  cidade classificada como Património Mundial pela UNESCO, famosa pela sua
  arquitetura singular, bairros históricos e gastronomia tradicional.


  A partir do Porto, pedale rumo ao sul ao longo das **ciclovias junto ao
  Atlântico**, passando por vilas piscatórias, praias infinitas, florestas de
  pinheiros e zonas naturais protegidas. Descubra locais emblemáticos como
  **Aveiro**, a famosa “Veneza portuguesa”, a costa imponente de **São Pedro de
  Moel**, as **ondas gigantes da Nazaré**, e a vila medieval de **Óbidos**, uma
  das mais belas povoações amuralhadas do país.


  Este **roteiro de bicicleta entre Porto e Lisboa** é perfeito para quem
  procura umas **férias de ciclismo em Portugal**, combinando natureza,
  património cultural e gastronomia local. Quer opte pelo itinerário completo ou
  pela versão reduzida, desfrutará de paisagens inesquecíveis, sabores
  autênticos e de uma das **melhores rotas de ciclismo de Portugal**.
...
image:
  ...
  alt: Tour de bicicleta do Porto a Lisboa pela Costa Atlântica e Costa de Prata
code: SC 03
...
itinerary:
  ...
  - day: '2'
    description: >-
      ...
      também em casas de propriedade privada. Hotel 4 stars: **Furadouro Hotel**
    location:
      lat: '40.87313436'
      lng: '-8.67736816'
  ...
  - day: '5'
    description: >-
      ...
      junta ao Oceano.  Hotel 4 stars: Sweet Atlantic Hotel
    location:
      lat: '40.1482816'
      lng: '-8.8554141'
...
afterPricing: >-
  ...
  * Suplemento para quarto individual: LS: 880€, RS: 1.000€, HS: 1.120€,
  SS:1.240€ (opção premium extra 1.500€)

  * Suplemento para quarto individual itinerário reduzido: LS: 480€, RS: 600€,
  HS: 720€, SS.840€ (opção premium extra 1.050€)
