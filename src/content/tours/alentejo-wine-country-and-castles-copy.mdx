...
content: >-
  ...
  through the rolling hills to Estremoz, and then to Redondo and Monsaraz,
  enjoying the stunning views and local wine cellars. The tour includes visits
  to UNESCO World Heritage sites in Évora, with optional rides to Arraiolos. The
  trip concludes with a transfer back to Lisbon.
