...
subTitle: '1'
content: >-
  # **Douro Valley Bike Tour - Full Day**
  ...
  * The first 22 km are going in a descent way and the rest of the route can be
  in an uphill till Lamedo or relatively flat till Pinhão. It is also possible
  to do all the routes.

  * This easy bike tour can be adapted to be more challenging (difficult) - The
  Self guided the bike tour will have a moderate climb of 15 km. Book aelectric
  bicycle to make the route very easy.
  ...
  * **Day 1:** Transfer from Porto to Vila Real: Vila Real - Régua - Lamego: 40
  km - Sleep in Farm: Hotel rural Visconde Varzea or incluced in premium option
  ...
  * **Day 2:** Lamego - Pinhão: 44 km. Sleep in Farm: Hotel 3 \*: [LBV
  House](https://www.lbvhousehotel.com/en/Utilities/Homepage.aspx) or incluced
  in premium option [Quinta de la Rosa](https://www.quintadelarosa.com/)
