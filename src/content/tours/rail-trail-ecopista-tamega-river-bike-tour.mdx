...
image:
  ...
  alt: Full-day Douro Valley bike ride through vineyard terraces
code: CT 09
...
afterPricing: >-
  ...
  * City taxes is not included in the price package (approximately 2€ per person
  ...
  &nbsp;
seo:
  page_title: Douro Valley Full-Day Bike Tour | One Day, 25–77 km
  page_description: >-
    A single day in the Douro rather than a week: a rail trail from Vila Real to
    Pinhão via Régua and Lamego, 25, 50 or 77 km, transfer back. From €290.
  canonical_url:
