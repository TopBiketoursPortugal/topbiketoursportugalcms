...
content: >-
  ...
  do Baúlhe train station. The Historic center in Amarante, the vineyards and
  the forest, so unique in the Northern region, will be a surprise.
  ...
  people that is starting to cycle or just to know more about the region. This
  is a descent bike tour so the effort to do it will be few.

  To have a more relaxing time to explore the area 3 different options are
  offered in 3 different package.
  ...
  **Day 1:** Transfer from Porto to Arco do Baúlhe:
  ...
  - Arco do Baúlhe - Amarante: 40 km - Sleep in a 5 star hotel: [Casa da
  Calçada](https://www.casadacalcada.com/)
  ...
  **Day 1:** Transfer from Porto to Arco do Baúlhe:
  ...
  - Arco do Baúlhe - Mondim de Bastos: 16km - Sleep in a 4 star hotel: [Água
  Hotel](https://www.aguahotels.pt/)
...
feature:
  ...
  bokunLink: >-
    https://fareharbor.com/embeds/book/topbiketoursportugal/items/268432/?full-items=yes&flow=479509
  bokunId: ''
  textcolor: white
