...
content: >-
  ...
  * Day 1: Porto – Pinhão (110 km, transfer de comboio)
...
itinerary:
  ...
  - day: '6'
    description: >-
      ...
      and chestnuts, so much so that the "Sernancelhe" area is known has the
      chestnut county. You will understand how much chestnut the region actually
      produces from the road side scenery. With the river Távora by your side
      you can enjoy the wonderful geography, with mountains and valleys, which
      is a trademark image of this part of the country. If you have the time,
      take a visit to the XIIth century church. Hotel 4 \*: [Penedono
      Hotel](http://www.hotelmedieval.pt/) or upgrade to superior room with the
      "Premium" option
    location:
      lat: '40.98965764'
      lng: '-7.39509343'
