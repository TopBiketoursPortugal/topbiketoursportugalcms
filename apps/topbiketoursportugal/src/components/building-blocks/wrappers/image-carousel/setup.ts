...
export function setupImageCarousel(carousel: ImageCarouselElement): void {
  ...
  if (
    ...
    if (import.meta.env.DEV) {
      console.debug(
        'ImageCarousel: skipping setup, required elements missing',
        carousel
      );
    }
    return;
