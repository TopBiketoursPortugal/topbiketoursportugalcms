...
async function main() {
  ...
  try {
    ...
    if (settings.build) {
      if (settings.build.preserveOutput !== undefined) delete settings.build.preserveOutput;
      if (settings.build.includeGit !== undefined) delete settings.build.includeGit;
    }
